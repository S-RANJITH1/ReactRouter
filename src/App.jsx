...
function App() {
  let data = [
    ...
    {
      image:
        "https://img.freepik.com/free-photo/html-css-collage-concept-with-hacker_23-2150061984.jpg?w=996&t=st=1703416197~exp=1703416797~hmac=4a4c534fb7f62453e30076ff22355a091f4dfe3ac5964032814536dbb3d7b9eb",
      head: "Data Science",
      content:
    ...
    },
    {
      ...
      content:
        "Scalable Vector Graphics (SVG) has revolutionized the world of graphics and web design. This vectorAs it turns out, full stack developers rate their career happiness 3.4 out of 5 stars which puts them in the top 37% of careers.",
      date: "16",
      month: "Feberary",
    },
    {
    ...
    {
      image:
        "https://asc.army.mil/web/wp-content/uploads/2023/03/DACM_Career-Development-Model_700x395pixels-scaled.jpg",
      head: "Career Development",
      content:
    ...
    {
      image:
        "https://img.freepik.com/free-photo/standard-quality-control-collage-concept_23-2149595831.jpg?w=996&t=st=1703417670~exp=1703418270~hmac=acdae9674a6ebe2745166a7646b21153850f86d23f56322c773a2a78b224efae",
      head: "Cyber Security",
      content:
        "Cybersecurity professionals are responsible for protecting their company's information and data from attacks by hackers, viruses, or other cyber threats. These professionals typically work in teams with other IT specialists, such as software developers or programmers.",
      date: "15",
    ...
    {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsySUaDHOzVlfRXVMatQwEtP3kW14lixcBp_qfxXTCig&s",
      head: "Data Science",
      content:
